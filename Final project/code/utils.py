    ...
    for _, row in detections.iterrows():
        ...
        if (cls == "person") or (cls == "bicycle"):
            ...
            if show_text:
                ...
                cv2.putText(img, text, (x1, y1), font, font_scale, (0, 0, 0), 1, cv2.LINE_AA)
            if cls == "person":
                person_num += 1
            if cls == "bicycle": 
                bicycle_num += 1
    cv2.putText(img, "310515010", (10, 30), font, font_scale, (0, 0, 255), 1, cv2.LINE_AA)
    cv2.putText(img, f"number of person: {person_num}", (10, 60), font, font_scale, (255, 0, 0), 1, cv2.LINE_AA)
    cv2.putText(img, f"number of bicycle: {bicycle_num}", (10, 90), font, font_scale, (255, 0, 0), 1, cv2.LINE_AA)
    if show_img:
