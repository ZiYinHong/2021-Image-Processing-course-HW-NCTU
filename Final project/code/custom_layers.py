...
def yolov4_head(yolo_neck_outputs, classes, anchors, xyscale):
    # print(yolo_neck_outputs[0].shape)  # (None, 52, 52, 255)
    # print(yolo_neck_outputs[1].shape)  # (None, 26, 26, 255)
    # print(xyscale)                     # [1.2, 1.1, 1.05]
    # print(classes)                     # 80
    # print(anchors)                     #
    """
    [[[ 12  16]
    ...
    # bbox0, object_probability0, class_probabilities0, pred_box0
    # print(x[:4]) 
    """
    [<KerasTensor: shape=(None, 52, 52, 3, 4) dtype=float32 (created by layer 'tf.concat_1')>, 
    <KerasTensor: shape=(None, 52, 52, 3, 1) dtype=float32 (created by layer 'tf.math.sigmoid_1')>, 
    <KerasTensor: shape=(None, 52, 52, 3, 80) dtype=float32 (created by layer 'tf.math.sigmoid_2')>, 
    <KerasTensor: shape=(None, 52, 52, 3, 4) dtype=float32 (created by layer 'tf.concat')>]
    """
