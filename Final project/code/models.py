...
class Yolov4(object):
    ...
    def build_model(self, load_pretrained=True):
        ...
        # [<KerasTensor: shape=(None, 52, 52, 255) dtype=float32 (created by layer 'conv2d_93')>, 
        # <KerasTensor: shape=(None, 26, 26, 255) dtype=float32 (created by layer 'conv2d_101')>, 
        # <KerasTensor: shape=(None, 13, 13, 255) dtype=float32 (created by layer 'conv2d_109')>]
    ...
    def predict_img(self, raw_img, random_color=True, plot_img=True, figsize=(10, 10), show_text=True, return_output=False):
        ...
        #print(pred_output[0].shape)  # (1, 100, 4)
        #print(pred_output[1].shape)  # (1, 100)
        #print(pred_output[2].shape)  # (1, 100)
        #print(pred_output[3].shape)  # (1,)  # number of box
